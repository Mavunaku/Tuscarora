...
const INITIAL_INVENTORY = {
    'Farm House': [
        { id: 'fh1', name: 'Farmhouse #1', displayName: 'Farmhouse #1', bathroom: true, beds: '1 Queen Bed', price: 24 },
        { id: 'fh2', name: 'Farmhouse #2', displayName: 'Farmhouse #2', bathroom: true, beds: '2 Single Beds', price: 24 },
        { id: 'fh3', name: 'Farmhouse #3', displayName: 'Farmhouse #3', bathroom: true, beds: '1 Queen Bed', price: 24 },
        { id: 'fh4', name: 'Farmhouse #4', displayName: 'Farmhouse #4', bathroom: false, beds: '2 Single Beds', price: 24 },
        { id: 'fh5', name: 'Farmhouse #5', displayName: 'Farmhouse #5', bathroom: false, beds: '1 Queen Bed', price: 24 },
        { id: 'fh6', name: 'Farmhouse #6', displayName: 'Farmhouse #6', bathroom: false, beds: '2 Single Beds', price: 24 },
    ],
    'Club House': [
        { id: 'ch1', name: 'Clubhouse #1', displayName: 'Clubhouse #1', bathroom: true, inSuite: true, beds: '1 Queen Bed', price: 24 },
        { id: 'ch2', name: 'Clubhouse #2', displayName: 'Clubhouse #2', bathroom: true, beds: '2 Single Beds', price: 24 },
        { id: 'ch3', name: 'Clubhouse #3', displayName: 'Clubhouse #3', bathroom: true, beds: '1 Queen Bed', price: 24 },
        { id: 'ch4', name: 'Clubhouse #4', displayName: 'Clubhouse #4', bathroom: false, beds: '2 Single Beds', price: 24 },
        { id: 'ch5', name: 'Clubhouse #5', displayName: 'Clubhouse #5', bathroom: false, beds: '1 Queen Bed', price: 24 },
        { id: 'ch6', name: 'Clubhouse #6', displayName: 'Clubhouse #6', bathroom: false, beds: '2 Single Beds', price: 24 },
    ],
    'Lazy Lodge': [
        { id: 'll1', name: 'Lazy Lodge #1', displayName: 'Lazy Lodge #1', bathroom: true, inSuite: true, beds: '1 Queen Bed', price: 40 },
        { id: 'll2', name: 'Lazy Lodge #2', displayName: 'Lazy Lodge #2', bathroom: true, inSuite: true, beds: '1 Queen Bed', price: 40 },
    ]
};
